          ...
          <AccountProvider address={vitalikAddress} client={THIRDWEB_CLIENT}>
            <AccountBalance
              ...
              formatFn={(props: {
                ...
                `${Math.ceil(props.tokenBalance * 1000) / 1000} ${props.tokenSymbol}`
              }
              loadingComponent={<span>Loading...</span>}
            />
          </AccountProvider>
...
function App() {
  return <AccountProvider address="0xd8da6bf26964af9d7eed9e03e53415d37aa96045" client={thirdwebClient}>
    <AccountBalance 
      chain={ethereum} 
      loadingComponent={<span>Loading...</span>}
      formatFn={(props: AccountBalanceFormatParams) => \`\${Math.ceil(props.tokenBalance * 1000) / 1000} \${props.tokenSymbol}\`} />
  </AccountProvider>
}`}
        lang="tsx"
      />
